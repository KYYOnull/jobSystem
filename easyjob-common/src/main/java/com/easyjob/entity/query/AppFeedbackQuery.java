...
public class AppFeedbackQuery extends BaseQuery{
	...
	public void setClientLastSendTimeStart(String clientLastSendTimeStart) {this.clientLastSendTimeStart = clientLastSendTimeStart;}

	public String getClientLastSendTimeStart() {return this.clientLastSendTimeStart;}

	public void setClientLastSendTimeEnd(String clientLastSendTimeEnd) {this.clientLastSendTimeEnd = clientLastSendTimeEnd;}

	public String getClientLastSendTimeEnd() {return this.clientLastSendTimeEnd;}

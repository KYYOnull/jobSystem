...
public class AppDeviceQuery extends BaseQuery{
	...
	public void setDeviceIdFuzzy(String deviceIdFuzzy) {this.deviceIdFuzzy = deviceIdFuzzy;}

	public String getDeviceIdFuzzy() {return this.deviceIdFuzzy;}

	public void setDeviceBrandFuzzy(String deviceBrandFuzzy) {this.deviceBrandFuzzy = deviceBrandFuzzy;}

	public String getDeviceBrandFuzzy() {return this.deviceBrandFuzzy;}
	...
	public void setLastUseTimeStart(String lastUseTimeStart) {this.lastUseTimeStart = lastUseTimeStart;}

	public String getLastUseTimeStart() {return this.lastUseTimeStart;}

	public void setLastUseTimeEnd(String lastUseTimeEnd) {this.lastUseTimeEnd = lastUseTimeEnd;}

	public String getLastUseTimeEnd() {return this.lastUseTimeEnd;}

	public void setIpFuzzy(String ipFuzzy) {this.ipFuzzy = ipFuzzy;}

	public String getIpFuzzy() {return this.ipFuzzy;}
